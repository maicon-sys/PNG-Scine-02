              ...
              if (asset && asset.data) {
                try {
                  ...
                  elements.push(new Paragraph({
                    // FIX: The property for binary image data in the 'docx' library is 'data', not 'buffer'.
                    // This resolves a type mismatch error where the compiler was incorrectly inferring SVG options.
